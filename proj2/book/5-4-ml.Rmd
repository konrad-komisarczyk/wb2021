...
TODO- dnn reproduction controversies, feature importance comparison  

```{r Figure_3, out.width="60%", message=FALSE, fig.align='center', echo=FALSE, fig.cap="**Figure 3:**"}
include_graphics(path = "figures/icu_nn.png")
```

```{r Figure_4, out.width="60%", message=FALSE, fig.align='center', echo=FALSE, fig.cap="**Figure 4:**"}
