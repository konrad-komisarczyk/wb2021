...
However, the data we were provided doesn't recreate the figure in the article.
...
```
\newpage
```{r hist_ppv2, message=F, warning=F, cache=T, dependson='load'}
...
```{r st_antonius_scatter, fig.height=3}
